...
Employee Management System is a backend CRUD application built using Node.js, Express.js, and MongoDB.  
It allows users to manage employee records easily with REST APIs.
